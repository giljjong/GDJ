...
public class RequestLogginAspect {
	
	// 로거
	private static final Logger LOG = LoggerFactory.getLogger(RequestLogginAspect.class);
	...
	@Around("com.gdu.app08.aop.RequestLogginAspect.setPointCut()")	// setPointCut() 메소드에 설정된 포인트컷에서 동작하는 어드바이스
	public Object executeLoggin(ProceedingJoinPoint joinPoint) throws Throwable{	// @Around는 반드시 ProceedingJoinPoint joinPoint 선언해야 한다
