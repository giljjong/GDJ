...
public class Main {
	...
	public static void m3() {
		...
		// 교집합
		// 교집합 결과는 retainAll() 메소드를 호출한 set에 저장이 된다.
		// set1.retainAll(set2);
		// System.out.println(set1);
		
		// 합집합
		// 합집합 결과는 addAll() 메소드를 호출한 set에 저장이 된다.
		// set1.addAll(set2);
		// System.out.println(set1);
		
		// 차집합
		// 차집합 결과는 removeAll() 메소드를 호출한 set에 저장이 된다.
		// set1.removeAll(set2);
		// System.out.println(set1);
		
		// 부분집합 여부 판단
		boolean result1 = set1.containsAll(set3);	// set3가 set1의 부분 집합이면 true
		boolean result2 = set2.containsAll(set3);	// set3가 set2의 부분 집합이면 true
