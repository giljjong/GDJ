/*
    ...
    1. Trigger
    2. DML(INSERT, UPDATE, DELETE) 수행 후 트리거가 자동으로 수행 됨
...
CREATE OR REPLACE TRIGGER TRIG1
    ...
    ON DEPARTMENT   -- DEPARTMENT 테이블을 UPDATE 할 때 동작함
    FOR EACH ROW    -- UPDATE 되는 행마다 트리거가 동작함
BEGIN
...
CREATE OR REPLACE TRIGGER RETIRE_TRIG
    ...
    FOR EACH ROW
BEGIN
    INSERT INTO RETIRES (RETIRE_ID, EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID, RETIRE_DATE)
        VALUES (RETIRE_SEQ.NEXTVAL, :OLD.EMPLOYEE_ID, :OLD.FIRST_NAME, :OLD.LAST_NAME, :OLD.EMAIL, :OLD.PHONE_NUMBER, :OLD.HIRE_DATE, :OLD.JOB_ID, :OLD.SALARY, :OLD.COMMISSION_PCT, :OLD.MANAGER_ID, :OLD.DEPARTMENT_ID, SYSDATE);
END;
